        ...
        <main class="region region-content">
            ...
            <b-modal title="Add minter role" centered ref="modal-add-minter">
                <template v-if="!loading">
                    <input
                        v-model="input.newMinterAddress"
                        type="text"
                        class="form-control"
            ...
            <b-modal title="Transfer THX on Extdev" centered ref="modal-transfer-coin-extdev">
                <template v-if="!loading">
                    <div class="form-group">
                        <input
                            v-model="input.transferTokensAddress"
                            type="text"
                            class="form-control"
                            placeholder="0x0000000000000000000000000000000000000000"
                        />
                    ...
                    <div class="form-group">
                        <input
                            v-model="input.transferTokens"
                            type="number"
                            class="form-control"
                            v-bind:max="$store.state.balance.token"
                        />
                    </div>
                </template>
            ...
            <b-modal title="Transfer THX on Rinkeby" centered ref="modal-transfer-coin-rinkeby">
                <template v-if="!loading">
                    <div class="form-group">
                        <input
                            v-model="input.transferRinkebyCoinAddress"
                            type="text"
                            class="form-control"
                            placeholder="0x0000000000000000000000000000000000000000"
                        />
                    ...
                    <div class="form-group">
                        <input
                            v-model="input.transferRinkebyCoinAmount"
                            type="number"
                            class="form-control"
                            v-bind:max="$store.state.balance.token"
                        />
            ...
            <b-modal title="Transfer ETH" centered ref="modal-transfer-ether">
                <template v-if="!loading">
                    <div class="form-group">
                        <input
                            v-model="input.transferEtherAddress"
                            type="text"
                            class="form-control"
                            placeholder="0x0000000000000000000000000000000000000000"
                        />
                    ...
                    <div class="form-group">
                        <input
                            v-model="input.transferEtherAmount"
                            type="number"
                            class="form-control"
                            v-bind:max="$store.state.balance.token"
                        />
