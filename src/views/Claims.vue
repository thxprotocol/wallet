<template>
    <div>
        <b-container class="bv-example-row">
            ...
            <b-row class="mb-2" v-if="isConnected && getCurrentAmountOfTokens() > 0">
                <b-col>{{ 'You have ' + getCurrentAmountOfTokens() + ' tokens to claim' }}</b-col>
                <b-col>
                    <b-button class="float-right">Claim all tokens</b-button>
                </b-col>
            </b-row>
            <b-row class="mb-2" v-else-if="isConnected">
...
export default class Claims extends Vue {
    ...
    async getCurrentAmountOfTokens() {
        return await this.contract.methods.getAttempts().call();
    }
