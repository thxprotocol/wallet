                        ...
                        <div class="card-body">
                            ...
                            <template v-if="pool && rule">
                                <template v-if="!isClaimed && !$state.extdevPrivateKey">
                                    ...
                                    <p>Open your <a href="https://wallet.thxproject.com" target="_blank">THX Wallet</a> on a device with a camera and claim your reward by scanning this QR code.</p>
                                </template>
                                ...
                                <template v-if="isClaimed">
                                    <svg class="mt-3 mb-4 icon-trophy" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="img" viewBox="0 0 576 512">
                                    ...
                                    <p>A pool manager will review your claim before<br> your reward can be withdrawn.</p>
                                </template>
                            </template>
                        </div>
                    </div>
