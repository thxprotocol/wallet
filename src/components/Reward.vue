            ...
            <template slot="footer">
                ...
                <template v-if="isManager">
                    <div class="row" v-if="now < reward.endTime">
                        ...
                        <div class="col-md-6" v-if="!reward.hasVoted">
                            <button @click="vote(false)" :class="{ disabled: disabled }" class="btn btn-danger btn-block">
                                Reject
                            </button>
                        </div>
                        <div class="col-md-12" v-if="reward.hasVoted">
                            <button @click="revokeVote()" :class="{ disabled: disabled }" class="btn btn-link btn-block">
                                Revoke your vote
                            </button>
                        </div>
                    </div>
